                    ...
                    <div class="col-md-4 col-md-offset-4">
                        <div class="box box-danger  box-solid">
                            ...
                            <div class="box-footer">
                                <a href="<?php echo site_url('admin/users/groups');?>" class="btn btn-default">Cancel</a>
                                <a href="<?php echo site_url('admin/users/groups/del/'.$row['id']."/$confirm_id");?>" class="btn btn-primary pull-right">DELETE</a>
                            </div>
                        </div>
                    </div>
                </div>
