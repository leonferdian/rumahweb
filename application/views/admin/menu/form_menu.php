					...
					<!-- start: page -->
                        <section class="panel">
							...
							<div class="panel-body">
                                <?php echo form_open('admin/menu/'.$table.'/edit/'.$forms['id'], array('class'=>'form-horizontal form-bordered', 'id'=>'submit_form'));?>
                                    ...
                                    <div class="form-actions form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <a href="<?php echo site_url('admin/menu/'.$table);?>" class="btn btn-danger btn-sm"><i class="fa fa-ban"></i> Cancel</a>
                                        </div>
                                    </div>
                                <?php echo form_close(); ?>
							</div>
