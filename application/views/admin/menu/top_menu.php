					...
					<!-- start: page -->
                        <section class="panel">
							<header class="panel-heading">
								...
								<div class="row">
									<div class="col-md-5">
										<button type="button" class="btn btn-primary" data-action="<?php echo site_url('admin/menu/top_menu/add');?>" data-toggle="modal" data-target="#form_modal"><i class="fa fa-plus-square"></i> Add Menu</button>
									</div>
								</div>
							</header>
